...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerFactory<String, UploadVerificationMessage> consumerFactory() {
        ...
        deserializer.addTrustedPackages("com.dts.media");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, UploadVerificationMessage> kafkaListenerContainerFactory(
            ConsumerFactory<String, UploadVerificationMessage> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, UploadVerificationMessage> factory =
